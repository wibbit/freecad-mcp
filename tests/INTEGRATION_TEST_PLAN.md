...
| Sketch workflow | [test_plans/sketch_workflow.md](test_plans/sketch_workflow.md) | `create_datum_plane`, `create_sketch_on_plane`, `add_contour_to_sketch`, `extrude_sketch_bidirectional`, `pocket_sketch`, `attach_solid_to_plane` | Tested 2026-05-10 (`pocket_sketch` untested — added 2026-05-10) |
